    ...
    <body>
        <div class="row">
            <div class="container">
                ...
                <main>
                    <div class="card">
                        <div class="cardicon"><a href=""><img src="./images/cc.jpg"></a></div>
                        <div class="cardicon"><a href=""><img src="./images/pp.jpg"></a></div>
                        <div class="cardicon"><a href=""><img src="./images/ob.jpg"></a></div>
                    </div>
                    ...
                    <form action="./menu.php" method="POST">
                        ...
                        <button onclick="paymentSuccess()" class="button">Place Order</button>
                    </form>
